                  ...
                  IconButton(
                    onPressed: () {
                      AwesomeDialog(
                              ...
                              // ),),
                              title:
                                  '¿Está seguro que quiere eliminar el proyecto $nameProject?',
                              desc:
                                  'Estas a punto de eliminar el proyecto $nameProject permanenetemente.',
                              btnOkOnPress: () async {
                                try {
                                  await deleteProyecto(nameProject);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                          'Proyecto $nameProject eliminado con éxito'),
                                    ),
                                  );
                                } catch (error) {
                                  ScaffoldMessenger.of(context).showSnackBar(
